...
import { FileInput, Notification, Title, Group } from "@mantine/core";
    ...
    return (
        <div style={{ padding: "20px", backgroundColor: "#f9f9f9", borderRadius: "8px" }}>
            <Group style={{ margin: "20px 0" }}>
                <Title order={3} fw={500} c="royalGreen.3">
                    Upload Your CSV File
                </Title>
                <FileInput onChange={handleFileChange} multiple={false} placeholder="No file selected" />
            </Group>
            {error && (
                <Notification
                    title="Error"
